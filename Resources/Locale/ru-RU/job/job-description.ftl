...
#Arasaka
job-description-hoda = Управляйте своими сотрудниками отдела безопасности и следите за их эффективностью, подавляйте инакомыслие, и обеспечивайте безопасность секретов Arasaka.
job-description-chief-security-arasaka = Начальник охраны Arasaka
job-description-hopa = Глава персонала Arasaka
job-description-medic-arasaka = Врач Arasaka
job-description-netrunner-arasaka = Нетраннер Arasaka
job-description-operative-arasaka = Оперативник Arasaka
job-description-securityguard-arasaka = охранник Arasaka
job-description-squadcommander-arasaka = командир отряда Arasaka
job-description-technician-arasaka = техник Arasaka
job-description-warden-arasaka = варден Arasaka

#Civilian
job-description-citizen = обычный житель Найт-Сити
job-description-reaper = Не волнуйся, Ви, мы тебя быстро вылечим
job-description-fixer = Время делать деньги
